...
<style>
.box,.buttons button{border:2px solid #000}.buttons button,.fields,header{position:relative}.alert-error,.alert-success,.fields{text-align:center}*,::after,::before{box-sizing:border-box}body,html{border:0;font-family:"Open Sans",sans-serif;margin:0;padding:0}a{list-style:none;text-decoration:none}h1{height:.1em}header{align-content:center;border-bottom:2px solid #646464;padding-bottom:.5em;margin-top:2em;left:2em;width:92%}.buttons button{bottom:2.6em;display:block;filter:drop-shadow(2px 2px 2px #000);float:right;padding-block:5px;padding-inline:10px}header h1{margin-bottom:1.3em}#add-product-btn{right:11em}#delete-product-btn{left:3.5em}#save-product-btn{right:8em}#cancel-btn{left:3.7em}.alert-success{margin-top:2em;color:green}.alert-error{margin-top:2em;color:red}#main_content{display:flex;flex-wrap:wrap;gap:2em 2em;justify-content:center;margin-block:3em;margin-inline:13em}.box{font-size:max(2.2vmin, 90%);height:13em;min-height:13em;min-width:15em;width:15em}.delete-checkbox{height:10%;margin-left:1em;margin-top:1.5em;width:7%}.fields{bottom:1em}.fields p{line-height:.6}
</style>